...
template = pn.template.FastListTemplate(
    site ="Spotify ",
    title='<h1 style="text-align:center;">Dashboard Application for Machine learning Algorthms</h1>',  # Center-align the title
    header_color="#1DB954",
...
template.main[:] = [tabs_layout]# Serve the app

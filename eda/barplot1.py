...
class BarPlotter:
    def __init__(self, data):
        ...
        filter_options = list(self.data[["album_name", "track_name", "track_genre", 'artists']])
...
bar_plotter = BarPlotter(df)  # Replace "your_data" with your actual dataset

# Make the BarPlotter instance servable
bar_plotter.layout.servable()